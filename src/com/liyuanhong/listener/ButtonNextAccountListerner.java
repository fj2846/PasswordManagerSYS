...
public class ButtonNextAccountListerner extends MouseAdapter{
	...
	public ButtonNextAccountListerner(JFrame frame,CurrentAcountItem itemAnchor,
...
//				}
				...
				if(accountsList.size() == 0){
					...
					if(itemAnchor.getAccountAnchor() < accountsList.size() - 1){
					...
					}else if(itemAnchor.getAccountAnchor() == accountsList.size() - 1){
						counter.setText(String.valueOf(itemAnchor.getAccountAnchor() + 1));
						Toolkit.getDefaultToolkit().beep();
						JOptionPane.showMessageDialog(frame, "这是最后一个账号！", 
