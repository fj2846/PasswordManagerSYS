...
public class LastAccountListener extends MouseAdapter{
	...
	public LastAccountListener(JFrame frame,CurrentAcountItem itemAnchor,
		...
		if(e.getButton() == MouseEvent.BUTTON1){
			if(itemAnchor.getAccountFile() == null){
				...
				if(accountsList.size() == 0){
					...
					currentElement = accountsList.get(accountsList.size() - 1);
					itemAnchor.setAccountAnchor(accountsList.size() - 1);
