...
public class DeleteCreatRuleListener extends MouseAdapter{
	...
	public DeleteCreatRuleListener(JFrame frame, RulesBean rulesBean,JList addedListArea,
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getButton() == MouseEvent.BUTTON1){
			if(addedListArea.getSelectedIndex() == -1){
				
			}else{
				addedRulesMap = rulesBean.getAddedRulesMap();
				selectKey = addedListArea.getSelectedValue().toString();
				addedRulesMap.remove(selectKey);
